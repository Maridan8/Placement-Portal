...
<html lang="en">
    ...
    <body>
        ...
        <section id="hero-animated" class="hero-animated d-flex align-items-center" style="margin-top: 50px">
            <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
                <img src="assets/img/hero-carousel/hero-carousel-3.svg" class="img-fluid animated" alt="">
                <h2>Welcome to <span>IIIT Ranchi Placement Cell</span></h2>
        ...
        <main id="main">
            <section id="featured-services" class="featured-services">
                <div class="container">
                    <div class="row gy-4" style="display: flex; align-items: center; justify-content: space-evenly;">
