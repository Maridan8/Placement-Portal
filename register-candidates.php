    ...
    <div class="wrapper">
          ...
          <div class="container">
            <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
              ...
              <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
                <div class="latest-job align-items-center" style="max-width: 70%; margin: 0 15%">
                  ...
                  <div class="form-group">
                    <input class="form-control input-lg" type="text" id="email" name="email" placeholder="Email *" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <input class="form-control input-lg" type="text" id="hsc" name="hsc" placeholder="HSC % *" required>
                  </div>
                  <div class="form-group">
                    <input class="form-control input-lg" type="text" id="ssc" name="ssc" placeholder="SSC % *" required>
                  </div>
                  <div class="form-group">
                    <input class="form-control input-lg" type="text" id="ug_cgpa" name="ug_cgpa" placeholder="UG CGPA *" required>
                  </div>
                  <div class="form-group">
                    <input class="form-control input-lg" type="text" id="pg_cgpa" name="pg_cgpa" placeholder="PG CGPA">
                  </div>
      ...
      <footer class="main-footer" style="margin-left: 0px;">
        <div class="text-center">
          <strong>Copyright &copy; 2023 Placement Portal.</strong> All rights reserved.
        </div>
      </footer>
